---
layout: default
title:  "Voiture d'occasion: les déboires, partie 2"
date:   2026-09-05 12:00 +0100
description: "Huit mois après l'achat et plus de six mois après les premiers problèmes, où en est-on ?"
categories: 
- voiture
...
- [Petit rappel du premier épisode.](#petit-rappel-du-premier-épisode)
- [Devis et garantie](#devis-et-garantie)
- [Refus et lancement des procédures](#refus-et-lancement-des-procédures)
- [Mauvaise foi du vendeur](#mauvaise-foi-du-vendeur)
- [L'expertise](#lexpertise)
- [La conclusion de l'expert](#la-conclusion-de-lexpert)
- [Suite ?](#suite-)
- [Tristesse](#tristesse)
...
![La C3](/assets/img/2525-09-05/ma_c3.jpg)
...
- ceux (dont deux autres Citroën) qui me confirment un minimum de 6-8000 euros, et qui me conseillent de me retourner contre le vendeur,
- ceux qui ne répondent jamais,
- ceux qui refusent de se mettre en relation avec la garantie,
- ceux qui me proposent uniquement du black à 4500 euros,
- ceux qui me disent de venir, je me pointe (30 kms aller-retour, 7 mises en sécurité de la boite sur le trajet) et qui une fois sur place me disent qu'ils ne prennent pas en charge ce genre de véhicule,
- ceux qui me disent ok et de leur fournir les infos pour la garantie, puis qui ne me répondent plus et me bloquent ensuite.
...
- un devis à 5000 euros pour une boite de plus de 60000 kms, garantie d'un an mais qui devrait aller bien plus loin,
- un devis à 5600 euros pour une boite de 20000 kms, garantie d'un an, mais plus risqué.

![Devis boite neuve](/assets/img/2525-09-05/devis_occaz.jpg)
...
![Refus garantie](/assets/img/2525-09-05/refus_garantie.jpg)
...
- La voiture n'avait aucun souci et fonctionnait parfaitement à la vente.
- Pour prouver que c'est un vice caché, il faudrait prouver qu'il savait et qu'il l'a caché (pas du tout la définition d'un vice caché)
- L'acheteur (moi) était parfaitement au courant du problème, c'est sur le CT, donc achat en connaissance de cause (on passe d'un souci d'antipollution à 250 euros à une boite à plus de 5000 euros)
- J'ai parcouru 1100 kms, ça peut être de ma faute (pourquoi ? comment ? Je ne sais pas)
- Les sous de la vente c'était pour acheter une voiture à son fils qui en a besoin pour travailler (comprendre: je n''ai pas de sous pour rembourser - alors pourquoi avoir vendu la C3 qui fonctionnait si bien ?)
- Il est très perturbé par cette histoire, en plus il est malade (les violons).
- Il refuse donc de réparer ou l'annulation de la vente (fin de non recevoir).
...
- un échange (questions, tout l'historique de la voiture, avec documents originaux, factures, entretien, CT, courriers, etc.), 
- un essai routier, 
...
![bva](/assets/img/2525-09-05/bva.jpg)
...
![Journal des erreurs](/assets/img/2525-09-05/jdd_erreurs.jpg)

*Le journal des erreurs a saturé à 65551 kms. Des pages de soucis BVA et antipollution*

Trois codes sont relevés:
- **P0013**: défaut de commande d'électrovanne d'échappement: c'est le "vrai" souci d'**antipollution**;
- **P0014**: défaut déphasage arbre à came échappement cohérence local: idem, **antipollution**;
- **P1167**: Défaut de régulation de pression: c'est le problème de **boite automatique**.

![antipollution](/assets/img/2525-09-05/antipollution.jpg)
...
![rapport](/assets/img/2525-09-05/rapport_expertise.jpg)

_Nos opérations d'expertise ont permis de confirmer que le véhicule était affecté d'une avarie en lien avec un défaut interne de la boite de vitesse. Ce désordre est consécutif à un manque de pression d'alimentation en huile, provoquant l'impossibilité de passage des rapports, ainsi qu'un phénomène de patinage. L'historique des défauts permet de confirmer que ce désordre était déjà présent à 65 551 km. La mémoire de ce journal des défauts étant saturée, il nous est impossible de déterminer d'autres kilométrages d'apparition éventuelles. En effet, les nouveaux défauts pouvant apparaître ne sont plus enregistrés dans la mémoire des calculateurs._


_Le code défaut P1167 en lien avec cette avarie était de toute façon présent sur le PV de contrôle technique fourni à la vente. Le vendeur mandataire ayant indiqué à M. ROHAUT, qu'il s'agissait d'un défaut antipollution sans importance. M. ROHAUT étant profane de l'automobile, ne pouvait de toute évidence pas interpréter ce code défaut._


_Compte tenu de ces éléments, nous vous confirmons que le véhicule est impropre à l'usage, que la tentative de réparation faite dans le cadre de la garantie est restée infructueuse et que, de ce fait, la responsabilité du mandataire et du vendeur particulier peut être recherchée._

# Suite ?

Mon prochain rendez-vous avec l'assistance juridique aura lieu la semaine prochaine. Plusieurs scénarios sont possibles:
- Mise en demeure du vendeur et/ou du mandataire pour annulation de la vente / reprise du véhicule.
