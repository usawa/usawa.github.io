...
- [Des projets aux cycles plus court](#des-projets-aux-cycles-plus-court)
- [L’envie de voir ses projets aboutir](#lenvie-de-voir-ses-projets-aboutir)
- [Perception versus vraie liste des projets](#perception-versus-vraie-liste-des-projets)
